# -----------------------------------------------------------------------------#
# CHME0040 Data Science & Statistics (2024-25)
# Practical 3 
# -----------------------------------------------------------------------------#
...
setwd("G:/My Drive/University Work/UCL PhD Work/PGTA Materials/Institute of Health Informatics/CHME0040 Data Science & Statistics (2024-25)/Session III - Linear Regression Cont/Corrected Scripts (24.10.10)")
...
# Install packages (delete # to run if not already installed)
